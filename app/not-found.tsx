...
import { NavbarClient } from "@/feature/Marketing/navbar-client";
import { Footer } from "@/feature/Marketing/footer";

export default function NotFound() {
  return (
    <>
      <NavbarClient featuredPosts={[]} />
      <section className="relative px-4 py-24 md:py-32 overflow-hidden min-h-[calc(100vh-20rem)]">
      ...
      <div
        className="absolute inset-0 -z-10 bg-[radial-gradient(ellipse_at_50%_50%,hsl(var(--primary)/0.4),transparent_50%)]"
        aria-hidden="true"
      />

      {/* Radial Gradient Background - Secondary Blur Layer */}
      <div
        className="absolute inset-0 -z-10 bg-[radial-gradient(ellipse_at_50%_50%,hsl(var(--primary)/0.68),transparent_40%)] blur-[50px]"
        aria-hidden="true"
      />

      {/* Enhanced Corner Brackets - Top */}
      ...
      <div className="container mx-auto max-w-4xl">
        <div className="flex flex-col items-center text-center space-y-6 relative z-10">
          <BlurFade delay={0.1} inView>
            <h1 className="relative text-7xl md:text-8xl lg:text-9xl font-semibold tracking-tighter leading-[1.1]">
